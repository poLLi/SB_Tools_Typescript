                ...
                <b-card class="shadow">
                    ...
                    <div class="forwardThruster">
                        ...
                        <b-row v-for="(thruster, i) in thrusters" :key="'forwardThruster_' + i">
                            <b-col v-if="thruster.title == 'SHIP_CALC.THRUSTER.PLASMA_BODY'" sm="12"><hr /></b-col>
                            <b-col sm="8">{{ $t(thruster.title) }}</b-col>
                            <b-col sm="4">
                                <b-form-input v-model="thrusters[i].forwardCount" type="number" min="0"></b-form-input>
                            </b-col>
                        </b-row>
                    </div>
                    <hr />
                    <div class="backwardThruster">
                        ...
                        <b-row v-for="(thruster, i) in thrusters" :key="'backwardThruster_' + i">
                            <b-col v-if="thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_BODY' && thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_RING'" sm="8">{{
                                $t(thruster.title)
                            }}</b-col>
                            <b-col v-if="thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_BODY' && thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_RING'" sm="4">
                                <b-form-input v-model="thrusters[i].backwardCount" type="number" min="0"></b-form-input>
                            </b-col>
                        </b-row>
                    </div>
                    <hr />
                    <div class="maneuverThruster">
                        ...
                        <b-row v-for="(thruster, i) in thrusters" :key="'maneuverThruster_' + i">
                            ...
                            <b-col v-if="thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_BODY' && thruster.title != 'SHIP_CALC.THRUSTER.PLASMA_RING'" sm="4">
                                <b-form-input v-model="thrusters[i].maneuverCount" type="number" min="0"></b-form-input>
                            </b-col>
                        </b-row>
                    </div>
                </b-card>
                        ...
                        <b-card class="shadow">
                            ...
                            <div class="propList">
                                <b-row>
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="shipMass" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                                <b-row>
                                    <b-col sm="8">{{ $t('SHIP_CALC.WEIGHT_CARGO.CRATES') }}</b-col>
                                    <b-col sm="4">
                                        <b-form-input v-model="oreCrates" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                        </b-card>
                        ...
                        <b-card class="shadow">
                            ...
                            <div class="propList">
                                ...
                                <b-row v-for="(tank, i) in propellantTanks" :key="'propellantTank_' + i">
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="tank.count" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                            <hr />
                            <div class="fuelList">
                                ...
                                <b-row v-for="(chamber, i) in fuelChambers" :key="'chamber_' + i">
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="chamber.count" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                            <hr />
                            <div class="genList">
                                ...
                                <b-row v-for="(generator, i) in generators" :key="'generator_' + i">
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="generator.count" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                            <hr />
                            <div class="batList">
                                ...
                                <b-row v-for="(battery, i) in batteries" :key="'battery_' + i">
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="battery.count" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                            <hr />
                            <div class="coolList">
                                ...
                                <b-row v-for="(cooling, i) in coolings" :key="'cooling_' + i">
                                    ...
                                    <b-col sm="4">
                                        <b-form-input v-model="cooling.count" type="number" min="0"></b-form-input>
                                    </b-col>
                                </b-row>
                            </div>
                        </b-card>
                            ...
                            <div class="toolsList">
                                <div v-for="(tool, i) in tools" :key="'tool_' + i">
                                    <b-row>
                                        ...
                                        <b-col sm="4">
                                            <b-form-input v-model="tool.count" type="number" min="0"></b-form-input>
                                        </b-col>
                                    </b-row>
                                    <b-row v-if="tool.id == 'ML' && tool.count >= 1">
                                        <b-col sm="8 text-muted"> ↳ {{ $t('SHIP_CALC.TOOLS.MINING_BATTERY_TIME') }} </b-col>
                                        <b-col sm="4">
                                            <b-form-input v-model="tool.battery_time" type="number" min="0"></b-form-input>
                                        </b-col>
                                    </b-row>
                                    <b-row v-if="tool.id == 'OC' && tool.count >= 1">
                                        <b-col sm="8 text-muted"> ↳ {{ $t(tool.title) }} Power </b-col>
                                        <b-col sm="4">
                                            <b-form-input v-model="tool.energy" type="number" min="0"></b-form-input>
                                        </b-col>
                                    </b-row>
                                </div>
                            </div>
                            ...
                            <div class="weaponList">
                                <div v-for="(weapon, i) in weapons" :key="'tool_' + i">
                                    <b-row v-if="weapon.id != 'OC'">
                                        ...
                                        <b-col sm="4">
                                            <b-form-input v-model="weapon.count" type="number" min="0"></b-form-input>
                                        </b-col>
                                    </b-row>
                                </div>
                            </div>
                ...
                <b-card class="shadow">
                    ...
                    <div class="resList">
                        ...
                        <b-row>
                            ...
                            <b-col v-if="totalHeat > totalCooling" sm="4 text-danger"> {{ totalCooling }} °C </b-col>
                            <b-col v-if="totalHeat <= totalCooling" sm="4"> {{ totalCooling }} °C </b-col>
                        </b-row>
                        <hr />
                        <b-row>
                        ...
                        <b-row>
                            ...
                            <b-col v-if="totalEnergyOutput < totalUsedEnergyIdle" sm="4 text-danger"> {{ totalUsedEnergyIdle }} e/s </b-col>
                            <b-col v-if="totalEnergyOutput >= totalUsedEnergyIdle" sm="4 text-primary"> {{ totalUsedEnergyIdle }} e/s </b-col>
                        </b-row>
                        <b-row>
                            <b-col sm="8">{{ $t('SHIP_CALC.CALCULATION.ENERGY_DRAIN_THRUSTER') }}</b-col>
                            <b-col v-if="totalEnergyOutput < totalUsedEnergyThruster" sm="4 text-danger"> {{ totalUsedEnergyThruster }} e/s </b-col>
                            <b-col v-if="totalEnergyOutput >= totalUsedEnergyThruster" sm="4 text-primary"> {{ totalUsedEnergyThruster }} e/s </b-col>
                        </b-row>
                        <b-row>
                            <b-col sm="8">{{ $t('SHIP_CALC.CALCULATION.ENERGY_DRAIN_TOOLS') }}</b-col>
                            <b-col v-if="totalEnergyOutput < totalUsedEnergyTools" sm="4 text-danger"> {{ totalUsedEnergyTools }} e/s </b-col>
                            <b-col v-if="totalEnergyOutput >= totalUsedEnergyTools" sm="4 text-primary"> {{ totalUsedEnergyTools }} e/s </b-col>
                        </b-row>
                        <b-row>
                            <b-col sm="8">{{ $t('SHIP_CALC.CALCULATION.ENERGY_DRAIN_WEAPONS') }}</b-col>
                            <b-col v-if="totalEnergyOutput < totalUsedEnergyWeapons" sm="4 text-danger"> {{ totalUsedEnergyWeapons }} e/s </b-col>
                            <b-col v-if="totalEnergyOutput >= totalUsedEnergyWeapons" sm="4 text-primary"> {{ totalUsedEnergyWeapons }} e/s </b-col>
                        </b-row>
                        <hr />
                        ...
                        <b-row>
                            <b-col>
                                <b-button v-b-toggle.thrust variant="primary"> <b-icon icon="tools"></b-icon> {{ $t('SHIP_CALC.CALCULATION.THRUST') }} </b-button>
...
export default Vue.extend({
    ...
    computed: {
        ...
        // ------------------------------------------------------------------------------
        // ---- Propellant / Fuel / Heat Calculation
        // ------------------------------------------------------------------------------
        ...
        totalUsedPropellantThrusterF(): number {
            let res: number = 0;
            for (let i = 0; i < this.thrusters.length; i++) {
        ...
        totalUsedPropellantThrusterFM(): number {
            let res: number = 0;
            for (let i = 0; i < this.thrusters.length; i++) {
                res += this.thrusters[i].propellant * this.thrusters[i].forwardCount;
                res += this.thrusters[i].propellant * this.thrusters[i].maneuverCount;
            }
            return res;
        },
        ...
        totalCooling(): number {
            ...
            for (let i = 0; i < this.coolings.length; i++) {
                res += this.coolings[i].cooling * this.coolings[i].count;
            }
            return res;
        },

        neededBatteryML(): number {
            let res: number = 0;
            if (this.tools.filter((data) => data.id === 'ML')[0].count === 0) return 0;

            if (this.tools.filter((data) => data.id === 'ML')[0].battery_time !== 0) {
                const EnergyDrain =
        ...
        totalUsedEnergyThruster(): number {
            let res: number = 0;
            for (let i = 0; i < this.thrusters.length; i++) {
    ...
    mounted() {
        ...
        if (this.$route.query.d) {
            ...
            codec.decompress(this.$route.query.d).then((res: any): any => {
                if (res.v !== 1) return;
    ...
    methods: {
        countDownChanged(dismissCountDown: any): any {
        ...
        saveBuild() {
            ...
            const codec = require('json-url')('lzma');
            codec.compress(save).then((resault: any) => {
